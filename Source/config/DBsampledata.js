...
for (res in res_halls){
    Building.findOne({ name : res_halls[count] }, function(err, building) {
        ...
        if (building) {
            ...
            res.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
...
for (ac in academic_halls){
    ...
    Building.findOne({ name : academic_halls[ac_count] }, function(err, building) {
        ...
        if (building) {
            ...
            acBuilding.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
...
for (dc in data_center){
    Building.findOne({ name : data_center[dc_count] }, function(err, building) {
        ...
        if (building) {
            ...
            dcBuilding.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
...
for (lib in library){
    Building.findOne({ name : library[lib_count] }, function(err, building) {
        ...
        if (building) {
            ...
            libBuilding.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
...
for (rec in rec_center){
    Building.findOne({ name : rec_center[rec_count] }, function(err, building) {
        ...
        if (building) {
            ...
            recBuilding.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
...
for (o in other){
    Building.findOne({ name : other[o_count] }, function(err, building) {
        ...
        if (building) {
            ...
            oBuilding.data_entry = {date_time : new Date(), kw_hour : Math.floor(Math.random() * 4000)+1000};
            // save the building
