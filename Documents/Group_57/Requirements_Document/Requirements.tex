\documentclass[onecolumn, draftclsnofoot,10pt, compsoc]{IEEEtran}
    ...
    \begin{itemize}
        ...
        \item A user should be able to customize dashboard layouts in a grid-based orientation. A \hyperref[definition]{\textit{story}} page should have a customizable layout where a user can add different \hyperref[definition]{\textit{blocks}} with information relevant to their personal needs.
        ...
        \item The web application should be hav
