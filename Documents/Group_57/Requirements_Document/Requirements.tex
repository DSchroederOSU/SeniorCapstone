\documentclass[journal,10pt,onecolumn,compsoc]{IEEEtran} 
    ...
    \subsection{Scope}
	This project will provide a web application that displays different collections of energy use reports for campus buildings. Each of these collections will be customizable, with the ability to add, remove, and filter building data according to user preference. The web application will allow users to visually comprehend energy data in a way that can raise awareness about consumption and reduce the campus-wide carbon footprint. The web application will also have three different permission levels: Guest, User, and Admin. Each one will provide permissions to what can be viewed and edited.
...
\subsection{Definitions, acronyms, and abbreviations} \label{definition}
    ...
    Gantt Chart (Months)\\
        ...
        \begin{ganttchart}[
            ...
            \ganttbar{Configure Database Schema}{2017-11-20}{2017-12-30}\\
            ...
            \ganttbar{Test}{2018-03-01}{2018-03-31}\\
            \ganttbar{Prepare for Expo}{2018-04-01}{2018-04-30}\\ 
        \end{ganttchart}
    \newpage
