\documentclass[onecolumn, draftclsnofoot,10pt, compsoc]{IEEEtran}
    ...
    \begin{itemize}
        ...
        \item The web application should be able to scale up to as many buildings are on campus.
        \item A user should be able to customize dashboard layouts in a grid-based orientation. A ``story'' page should have a customizable layout where a user can add different ``blocks'' and graphs with information relevant to their personal needs.
