\documentclass[journal,10pt,onecolumn,compsoc]{IEEEtran} 
   ...
   \subsection{Reference Material}
	...
	\subsubsection{Functionality}
	Clicking it will redirect the user to our authentication service. After the user authenticates with Google Passport, it will return them to the homepage. Once they are logged in, they will have access to additional content on the navigation bar and cards.
	\subsubsection{Rationale}
