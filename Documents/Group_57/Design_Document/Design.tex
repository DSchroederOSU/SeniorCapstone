\documentclass[journal,10pt,onecolumn,compsoc]{IEEEtran} 
   ...
   \subsection{Reference Material}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/buildings.eps}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/Building_Select.eps}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/Dashboards.eps}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/Dashboard_Select.eps}
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/Stories.eps}
        \caption{A mock-up of a list of user generated story pages.}
    \end{figure}
	Users will may select the "My Stories" tab in the nav bar to bring up a list of their personal stories.
	Each story will contain a list of dashboards that was generated by the user to their preference. 
	The list of stories will detail the name of each story, the user that created each story, and the date and time of when each was created.
	The user will be able to search for stories by name in a search bar. 
    ...
    \begin{figure}[H]
        \includegraphics[width=\textwidth]{images/Stories_Select.eps}
