\documentclass[journal,10pt,onecolumn,compsoc]{IEEEtran} 
   ...
   \end{itemize}
    ...
    \subsubsection{Context Viewpoint}
        \textbf{Systems services and users}
        \begin{itemize}
            \item This section should describe our design decisions to compliment user actions (use cases).
            \item Potential UML diagram. 
            \item A black box showing what is to be designed functionally as the only available information about the design subject: a name and an associated set of externally identifiable services.
        \end{itemize}
    \subsubsection{Composition Viewpoint}        
    The Composition viewpoint describes the way the application is (recursively) structured into subsystems, components, and modules and establishes the roles of those parts.
        \begin{itemize}
            \item Identify the major design subsystems, components, and modules of the application.
            \item Localize and allocate functionality, responsibilities, or other design roles to these subsystems, components, and modules.
        \end{itemize}
    This is the overview of the modular components of the application. Modular components include the data models like stories, dashboards, and blocks that can be reused and designed independently while providing functionality to the overall application.
    ...
    The Dependency viewpoint specifies the relationships of interconnection and access among entities. These relationships include shared information, order of execution, or parameterization of interfaces.
        ...
        \end{itemize}
    This is a viewpoint for modeling the dependencies between our components from the composition viewpoint's constituents. For example the dependency between a story and its relative dashboards. Another example would be how a block components depends on multiple entities: the building objects stored within the block, the filter's current states, the graph template, and the graphing service. 
    ...
    \begin{figure}[H]
        ...
        \caption{A UML diagram to show how modular components are related.}
    \end{figure}
    \subsubsection{Interface Viewpoint}  
    Not really sure.
    \subsubsection{Structure Viewpoint}  
    The Structure viewpoint is used to document the internal constituents and organization of the application in terms of like elements (recursively).

    This viewpoint describes the structure of independent modular components and with relationships to other entities like connected, part of, enclosed, provided, and required.
    ...
    The resources attribute identifies and describes all of the resources external to the design that are needed by this entity to perform its function.\\

    This section should include information about AcquiSuite and AWS(or a hosting platform in general) as external resources and describe the need for these resources to be functional in order for the application to work properly.
    ...
    \begin{paddedtikzpicture}[node distance = 2cm, auto]
        ...
        \path (createdash.east)+(2,0) node (adddash)[subblock] {Add Dashboard};
    ...
    \caption{An overview of the application systems.} 
    \end{figure}
