\documentclass[journal,10pt,onecolumn,compsoc]{IEEEtran} 
    ...
    \begin{figure}[H]
        ...
        \caption{A mock-up of a list of user generated dashboard pages.}
    \end{figure}
    \subsubsection{Story Selection Page}
    \begin{figure}[H]
